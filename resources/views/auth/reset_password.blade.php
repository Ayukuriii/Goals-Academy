    ...
    <main id="lupa-password">
        <div class="content container-fluid d-flex flex-column justify-content-center align-items-center">
            <div class="card d-flex justify-content-center align-items-center">
                ...
                @if (session()->has('password-match'))
                    <div class="alert alert-danger alert-dismissible fade show" role="alert">
                        {{ session('password-match') }}
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                @endif
                @if (session()->has('reset-failed'))
                    <div class="alert alert-danger alert-dismissible fade show" role="alert">
                ...
                <form action="/update-password" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="password" class="form-control" name="confirmation_password" id="password"
                                required />
                        </div>
                    </div>
                    <button type="submit" class="btn-orange-static w-100" id="submit-simpan">Simpan</button>
                </form>
            </div>
