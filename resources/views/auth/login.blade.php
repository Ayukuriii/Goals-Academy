    ...
    <main class="w-100 m-auto">
        <div class="d-flex container align-items-center">
            ...
            <div class="card-login w-100">
                ...
                <p class="text-center" style="font-size: 12px; color: #363434;">Belum punya akun? <a href="/register"
                        class="fw-bold text-decoration-none text-dark" id="next-register" style="cursor: pointer">Daftar</a>
                </p>
            </div>
        </div>
    </main>
