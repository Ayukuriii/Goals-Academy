    ...
    <section class="container-fluid mb-5" id="user-profile">
        <div class="row mx-0 gap-2">
            ...
            <div class="card col ml-3 p-4 side-program">
                ...
                <form action="/tutor/edit/{{ $data->id }}" method="POST" class="form" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    ...
                    <div class="d-flex">
                        ...
                        <div class="form-button col-6 mt-3 mb-3 d-flex justify-content-end pt-5 pe-3">
