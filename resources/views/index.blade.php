...
@section('container')
                ...
                <form action="/send-email" method="POST">
                    <div class="input-group mb-3 hero-btn justify-content-between">
                        ...
                        <div class="input-group-append">
                            <button class="btn btn-orange-static" style="margin-top: 0" id="dapatkan-diskon" type="submit">Dapatkan Diskon</button>
            ...
            <div class="slider">
                ...
                <div class="product-card card-1 swiper-slide">
                    ...
                    <div class="card-content">
                        ...
                        <div class="bottom">
                            <button class="btn btn-orange-static product-btn btn-pc" id="join-now-1">Daftar Sekarang</button>
    ...
    <div class="daftar-container">
        ...
        <button type="submit" class="btn btn-center btn-orange-static"><a href="https://wa.me/6282147638286" alt="">Tanya
                Sekarang</a></button>
    </div>
    <!-- End Daftar Sekarang -->
