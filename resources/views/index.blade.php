...
@section('container')
        ...
        <div class="hero-container">
            <div class="hero-left-content">
                ...
                <div class="input-group mb-3 hero-btn">
                    ...
                    <button class="btn btn-outline-secondary"  id="dapatkan-diskon" type="button">Dapatkan Diskon ></button> <!--Button Dapatkan Diskon-->
                    </div>
                </div>
            
                <div class="hero-image"><img class="img-fluid" alt="" src="image/assets/images/header/hero-img.png" /></div> <!-- Screen > 1000px -->
                <div class="hero-image-mobile"><img class="img-fluid" alt="" src="image/assets/images/header/hero-img.png" /></div> <!-- Screen < 768px -->
            </div>
        </div>
    </section>
    <!-- End Header -->
    ...
    <div class="modal" id="popup-diskon">
        <img class="img-fluid popup-diskon-dekstop" src="image/assets/images/header/popup-diskon.jpeg" alt="" /> <!--Pamflet Popup Tab/Laptop-->
        <img class="img-fluid popup-diskon-mobile" src="image/assets/images/header/popup-diskon-mobile.png" alt="" /> <!--Pamflet Popup Hp -->
    ...
    <div class="promo"id="promo">
        ...
        <div class="swipper-container swiper">
            ...
            <img src="image\assets\images\promo\left-arrow.png" id="button-promo-left" onclick="swipeLeft"> <!--button klik kiri-->
            </div>
            <div class="swipe-right">
                <img src="image\assets\images\promo\left-arrow.png" id="button-promo-right" onclick="swipeRight"> <!--button klik kanan-->
            </div>
    ...
    <h1>Kenapa memilih Goals Academy?</h1>
        <div class="reason-card-wrapper">
            ...
            <p>Goals Academy memiliki mekanisme <br> penyusunan skripsi yang efektif dan <br> efisien dalam 3 bulan.</p>
            </div>
            ...
            <div class="reason-card">
            <div class="text-content">
            <h3>Dibimbing oleh<br> Tutor Muda yang <br><span class="orange">Professional dan<br> Friendly</span></h3>
            ...
            <p>Bimbingan skripsi jadi lebih asik <br> dan mudah dengan waktu chat <br> dengan Tutor yang fleksibel 24/7.</p>
            </div>
    ...
    <div class="product-container" id="product">
        ...
        <div class="swipper-container swiper">
            <!-- <div class="swipe-left">
                <img src=".\assets\images\promo\left-arrow.png" id="button-product-left" onclick="swipeLeft">
            </div>
            <div class="swipe-right">
                <img src=".\assets\images\promo\left-arrow.png" id="button-product-right" onclick="swipeRight">
            </div> -->
            <div class="slider">
                <!-- <div class="card-wrapper swiper-wrapper"> -->
                <div class="product-card card-1 swiper-slide"> <!-- Product Card 1-->
                    <div class="product-image"><img class="img-fluid" alt="" src="image/assets/images/banner/program_2.png"/></div>
                    <div class="card-content">
                        ...
                        <div class="bottom">
                            <button class="btn product-btn btn-pc" id="join-now-1">Daftar Sekarang</button> <!--button untuk pop up (>768px)-->
                            <button class="btn product-btn btn-mobile"><a class="links-hidden" href="dibimbing-sekali.html">Daftar Sekarang</a></button> <!--button untuk hp (< 485px)-->
                        </div>
                    </div>
                </div>

                <!-- <div class="product-card card-2 swiper-slide" id="dibimbingberkelompok">
                    <div class="product-image"><img class="img-fluid" alt="" src="./assets/images/banner/program_3.png"/></div>
                    <div class="card-content">
                ...
                <div class="product-card card-3 swiper-slide" id="webinarskripsi">
                    <div class="product-image"><img class="img-fluid" alt="" src="./assets/images/banner/program_1.png"/></div>
                    <div class="card-content">
    ...
    <div class="modal-container" id="modal1"> 
        <div class="modal-content">
            <div class="top-modal">
                <div class="modal-image"><img class="img-fluid" src="image/assets/images/banner/program_2.png" alt="" /></div>
            ...
            <div class="bottom-modal">
                ...
                <p>Bimbingan Skripsi dalam waktu yang ditentukan bersama dengan Tutor, Bisa pilih mau online ataupun offline </p>	
                <div class="modal-btn-wrapper">
                    <p>Rp 43.000/sesi</p>
                    <div class="kode-btn">
                    <a class="modal-btn btn-pay" href="https://lynk.id/goalsacademy" target="_blank">Daftar</a></div>
                </div>
            </div>
        </div>
	</div>
        ...
        <div class="modal-content">
            ...
            <div class="bottom-modal">
                <div class="modal-btn-wrapper">
                    <p>Rp 925.000</p>
                    <div class="kode-btn">
                    <p id="kode">Masukkan kode "<spanstyle="font-weight: bold;">CEPATLULUS</spanstyle=>"<br> untuk mendapatkan diskon sebesar 20%</p>
                    <a class="modal-btn btn-pay" href="https://lynk.id/goalsacademy" target="_blank">Daftar</a></div>
                </div>
            </div>
        </div>
    ...
    <div class="daftar-container">
        <div class="text-daftar">
            <h3>Klik <span>Tanya Sekarang</span> untuk <span>konsultasi</span> ke kami <br>
                mengenai rekomendasi program<br> yang cocok buat kamu.
            </h3>
        </div>
        <button type="submit" class="btn btn-center"><a href="https://wa.me/6282147638286" alt="">Tanya Sekarang</a></button>
    </div>
    <!-- End Daftar Sekarang -->
        ...
        <div class="accordion">
            <div class="accordion-item">
                ...
                <div class="accordion-item-body">
                    ...
                    Kami menyediakan 2 program yaitu offline dan online. Program offline ini diadakan bagi mahasiswa yang bertempatan di Malang dan ingin melakukan bimbingan skripsi secara tatap muka dengan Tutor Goals Academy. Kami juga menyediakan program online bagi mahasiswa yang ingin melakukan bimbingan skripsi secara daring dengan berkelompok maupun individu.
                    </div>
                </div>
            </div>
            ...
            <div class="accordion-item">
                ...
                <div class="accordion-item-body">
                    <div class="accordion-item-body-content">
                    Untuk program dibimbing berkelompok dan privat, mahasiswa akan dibimbing 2 hingga 4 kali dalam sebulan sesuai dengan schedule yang telah ditentukan pada saat pengumuman pembagian kelompok dan kesepakatan kalian diawal dengan Tutor Goals Academy.
                    </div>
                </div>
            </div>
                ...
                <div class="accordion-item-body">
                    <div class="accordion-item-body-content">
                        <ul style="padding-left: 1rem">
                            ...
                            Pastikan juga perangkatmu sudah terkoneksi dengan internet yang stabil agar proses bimbinganmu berjalan dengan lancar.
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="accordion-item">
                ...
                <div class="accordion-item-body">
                    <div class="accordion-item-body-content">
                    Ilmu Hukum, Pendidikan, Ekonomi dan Bisnis (manajemen, bisnis, akuntansi, ekonomi, administrasi), 
                    Sosial dan Politik (Sosiologi, Ilmu Kesejahterhaan Masyarakat, Ilmu Pemerintah, Ilmu Komunikasi, Hubungan Internasional, Ilmu Politik, Psikologi).
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="testimoni-container" id="testimoni">
        <div class="title-testimoni">
            ...
            <i class="fa-solid fa-quote-left fa-2xl" style="color: #ff8854;"></i><br>Apa kata mereka<br>Tentang<br>Goals Academy
            </h1>
        </div>
        <div class="testimoni-mobile">
            <img class="img-fluid" src="image/assets/icons/petik.svg" alt="" />
            <h1 style="text-align: left;color: #ff8854;font-weight: bold;font-size: 20px;padding-left: 10px;">Apa Kata Mereka <br>Tentang Goals Academy</h1>
        </div>
                        ...
                        <div class="card-wrapper swiper-wrapper">
                            <div class="test-card card-1 swiper-slide">
                                <div class="card-header">
                                    <p class="bold">&quot;Diluar ekspektasi proposal skripsi aku dapat nilai A walaupun ada beberapa catatan revisi yang harus diperbaiki&quot;</p>
                                </div>

                                <hr />
                                <div class="card-content">
                                    <div class="user-profile">
                                        <div class="user-img"><img alt="" class="card-img" src="image/assets/images/testimoni/rinda.jpg" /></div>
                            ...
                            <div class="test-card swiper-slide">
                                <div class="card-header">
                                    <p class="bold">&quot;Bimbingan sama dospem disuruh ganti judul dan bahkan sering ganti judul, setelah bimbingan di goals academy jadi paham judul skripsi yang menarik dan sesuai dengan penelitianku&quot;</p>
                                </div>

                                <hr />
                                <div class="card-content">
                                    <div class="user-profile">
                                        <div class="user-img"><img alt="" class="card-img" src="image/assets/images/testimoni/hilda.jpeg" /></div>
                            ...
                            <div class="test-card swiper-slide">
                                <div class="card-header">
                                    <p class="bold">&quot;Sebelum bimbingan di goals academy bingung dan ngga paham sama sekali terkait penggunaan SPSS, setelah daftar bimbingan dan tutornya simple banget aku jadi paham terkait SPSS dan aku bisa mulai bimbingan lagi dengan dospem&quot;</p>
                                </div>

                                <hr />
                                <div class="card-content">
                                    <div class="user-profile">
                                        <div class="user-img"><img alt="" class="card-img" src="image/assets/images/testimoni/haris.jpeg" /></div>
                            ...
                            <div class="test-card swiper-slide">
                                <div class="card-header">
                                    <p class="bold">&quot;Penyampaian waktu bimbingan mudah dicerna, progress skripsiku jadi lebih cepat&quot;</p>
                                </div>

                                <hr />
                                <div class="card-content">
                                    <div class="user-profile">
                                        <div class="user-img"><img alt="" class="card-img" src="image/assets/images/testimoni/ravly.jpeg" /></div>
                            ...
                            <div class="test-card swiper-slide">
                                <div class="card-header">
                                    <p class="bold">&quot;Alhamdulillah setelah ikut bimbingan di goals academy dapat inspirasi tentang topik apa yang mau saya bahas untuk dijadikan judul skripsi&quot;</p>
                                </div>

                                <hr />
                                <div class="card-content">
                                    <div class="user-profile">
                                        <div class="user-img"><img alt="" class="card-img" src="image/assets/images/testimoni/wendi.jpeg" /></div>
                ...
                <div class="swiper-container swiper" id="swiper-bottom">
                    <div class="testimoni-slide" id="slide-bottom">
                        <div class="card-wrapper swiper-wrapper">
                            <div class="test-card swiper-slide">
                                <div class="card-header">
                                    <p class="bold">&quot;Tutor di goals academy komunikatif banget dan apa yang disampaikan mudah dicerna, sehingga aku bisa dengan mudah menemukan kelemahan diskripsiku&quot;</p>
                                </div>

                                <hr />
                                <div class="card-content">
                                    <div class="user-profile">
                                        <div class="user-img"><img alt="" class="card-img" src="image/assets/images/testimoni/ferry.jpeg" /></div>
                            ...
                            <div class="test-card swiper-slide">
                                <div class="card-header">
                                    <p class="bold">&quot;Goals academy ngebantu banget dari yang tadinya masih gelap mikirin judul, setelah ikut bimbingan dengan tutor di goals academy buat pikiran jadi terang untuk nentuin judul&quot;</p>
                                </div>

                                <hr />
                                <div class="card-content">
                                    <div class="user-profile">
                                        <div class="user-img"><img alt="" class="card-img" src="image/assets/images/testimoni/kafhid.jpeg" /></div>
                            ...
                            <div class="test-card swiper-slide">
                                <div class="card-header">
                                    <p class="bold">&quot;Setelah ikut bimbingan di goals academy yang sebelumnya belum kepikiran mau mulai skripsi dari mana, sekarang jadi termotivasi dan paham mau mulai skripsian dari mana&quot;</p>
                                </div>

                                <hr />
                                <div class="card-content">
                                    <div class="user-profile">
                                        <div class="user-img"><img alt="" class="card-img" src="image/assets/images/testimoni/maudy.png" /></div>
                            ...
                            <div class="test-card swiper-slide">
                                <div class="card-header">
                                    <p class="bold">&quot;Sempet bimbingan sama dosen pembimbing yang ke 3x nya dan stuck di Bab 3, bingung mau revisi mulai dari mana dan takut ngerombak ulang. Setelah daftar bimbingan skripsi di goals academy kunci permasalahan skripsiku terjawab dan aku bisa lanjut ngerjain skripsiku&quot;</p>
                                </div>
