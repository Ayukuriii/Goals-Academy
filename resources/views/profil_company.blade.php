...
<section id="profil_company" class="bg-2 py-5">
    <div class="profil-image container justify-content-center align-items-center mt-5">
        <div class="row card shadow border justify-content-center align-items-center py-5 col-12 mx-auto" style="background: #ffffff80">
            <img class="img-fluid logo-goals-photo col-6 col-md-4 col-xl-3 my-md-4 my-xl-4" alt="" src="{{ asset("image/assets/icons/LOGO PRIMARY_ORANGE.png") }}"/>
        </div>
