	  ...
	  <div id="navbar" class="navbar-collapse collapse text-center justify-content-end">
		<ul class="navbar-nav mx-auto">
		  ...
		  <li class="nav-item dropdown ps-3" id="account">
			<a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false" id="dropdown-profile">
			...
			<ul class="dropdown-menu">
				...
				<li>
					...
					@csrf
					<button type="submit" class="dropdown-item" id="log-out"><i class="bi bi-box-arrow-right"></i>Logout</button>
					</form>
				</li>
			</ul>
			</li>
		  @else
			<a href="/login" class="btn btn-login" id="step-login">Login</a> <!--Button Login-->
		  @endauth
		</ul>
	  </div>
	</div>
